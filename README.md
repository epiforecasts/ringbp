...
res <- scenario_sim(
  n_sim = 10, ## 10 simulations
  num_initial_cases = 1, ## one initial case in each of the simulations
  prop_asym = 0, ## no asymptomatic infections
  ...
  disp_com = 0.16, ## dispersion parameter in the community
  disp_iso = 1, ## dispersion  parameter of those isolated
