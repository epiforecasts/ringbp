...
#>                    cases_per_gen
#>                           <list>
#>   1:  11, 41, 70, 99,145,185,...
#>   2:  11, 41, 70, 99,145,185,...
#>   3:  11, 41, 70, 99,145,185,...
#>   4:  11, 41, 70, 99,145,185,...
#>   5:  11, 41, 70, 99,145,185,...
#>  ---                            
#> 155:                         2,0
#> 156:                         2,0
#> 157:                         2,0
...
#>                    cases_per_gen
#>                           <list>
#>   1:  13, 21, 26, 72,127,125,...
#>   2:  13, 21, 26, 72,127,125,...
#>   3:  13, 21, 26, 72,127,125,...
#>   4:  13, 21, 26, 72,127,125,...
#>   5:  13, 21, 26, 72,127,125,...
#>  ---                            
#> 155:                         2,0
#> 156:                         2,0
#> 157:                         2,0
...
#>   5:                         1,0
#>  ---                            
#> 155:  19, 45, 61, 72,103,121,...
#> 156:  19, 45, 61, 72,103,121,...
#> 157:  19, 45, 61, 72,103,121,...
#> 158:  19, 45, 61, 72,103,121,...
#> 159:  19, 45, 61, 72,103,121,...
#> 
#> [[3]]
#>        sim  week weekly_cases cumulative effective_r0         cases_per_gen
#>      <int> <num>        <num>      <num>        <num>                <list>
...
#>  ---                                                                       
#> 155:     3    48            0       5939     1.482541 16,17,11,10,26,80,...
#> 156:     3    49            0       5939     1.482541 16,17,11,10,26,80,...
#> 157:     3    50            0       5939     1.482541 16,17,11,10,26,80,...
#> 158:     3    51            0       5939     1.482541 16,17,11,10,26,80,...
#> 159:     3    52            0       5939     1.482541 16,17,11,10,26,80,...
```
