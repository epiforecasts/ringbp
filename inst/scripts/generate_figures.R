...
ggplot2::ggsave("inst/plots/fig_2.png")
...
ggplot2::ggsave("inst/plots/fig_3.png")


# Figure 4 ----------------------------------------------------------------

res %>%
  dplyr::filter(num.initial.clusters == 40) %>%
...
ggplot2::ggsave("inst/plots/fig_4.png")



# Figure 5 ----------------------------------------------------------------

ringbp::box_plot_max_weekly_cases(results = res, cap_cases = 5000, extinct_thresold = 0.05,
