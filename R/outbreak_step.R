...
#'}
outbreak_step <- function(case_data,disp.iso,disp.com,r0isolated,r0community,prop.asym,
  ...
  case_data <- data.table::rbindlist(list(case_data,prob_samples),use.names=TRUE)
