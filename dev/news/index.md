...
- Interventions can now activate after a delay rather than being active
  ...
  [`as_prob_function()`](https://epiforecasts.io/ringbp/dev/reference/as_prob_function.md)
...
- The time-based stopping criterion in
  [`outbreak_continue()`](https://epiforecasts.io/ringbp/dev/reference/outbreak_continue.md)
...
- Symptomatic individuals can now self-isolate without requiring a
  ...
  [`cross_check_opts()`](https://epiforecasts.io/ringbp/dev/reference/cross_check_opts.md)
  checks that the
  [`delay_opts()`](https://epiforecasts.io/ringbp/dev/reference/delay_opts.md)
  and
  [`event_prob_opts()`](https://epiforecasts.io/ringbp/dev/reference/event_prob_opts.md)
  ...
  isolated);
  [`sample_offspring()`](https://epiforecasts.io/ringbp/dev/reference/sample_offspring.md)
...
- Added vignettes on:
  ...
  - Getting started vignette (`ringbp.Rmd`), containing an overview of
    ...
    (e.g. [`extinct_prob()`](https://epiforecasts.io/ringbp/dev/reference/extinction.md)).
...
- The lower bound for the generation time returned by
  [`incubation_to_generation_time()`](https://epiforecasts.io/ringbp/dev/reference/incubation_to_generation_time.md)
...
- The outbreak simulation functions
  ...
  [`check_dist_func()`](https://epiforecasts.io/ringbp/dev/reference/check_dist_func.md)
  ...
  [`presymptomatic_transmission_to_alpha()`](https://epiforecasts.io/ringbp/dev/reference/presymptomatic_transmission_to_alpha.md).
