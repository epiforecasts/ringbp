...
contact tracing. It was based on an Ebola transmission model with ring
vaccination ([Kucharski et al. 2016](#ref-Kucharski2016)). The
[ringbp](https://epiforecasts.io/ringbp/) model was initially developed
...
[ringbp](https://epiforecasts.io/ringbp/) R package, see the Hellewell
et al. ([2020](#ref-Hellewell2020))
...
[ringbp](https://epiforecasts.io/ringbp/) from
