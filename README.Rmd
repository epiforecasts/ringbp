...
disease transmission in the presence of contact tracing. It was based on an
Ebola transmission model with ring vaccination [@Kucharski2016]. The `{ringbp}`
model was initially developed to support a paper written in early 2020 to assess
the feasibility of controlling COVID-19 [@Hellewell2020].

See the [companion analysis code](https://github.com/cmmid/ringbp) to reproduce
@Hellewell2020.

For more details on the methods implemented in the `{ringbp}` R package, 
see the @Hellewell2020 [paper](https://doi.org/10.1016/S2214-109X(20)30074-7),
and the [package documentation](https://epiforecasts.io/ringbp/articles/).
...
Alternatively, install pre-compiled binaries from [the epiforecasts R-universe](https://epiforecasts.r-universe.dev/ringbp)
