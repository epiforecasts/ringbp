...
It was initially developed to support a paper written in early 2020 to assess the [feasibility of controlling COVID-19](https://github.com/cmmid/ringbp.ncov).
...
```{r}
ggplot(
  data = res, ggplot2::aes(x = week, y = cumulative, col = as.factor(sim))
) +
